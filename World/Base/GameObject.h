...
#define REGISTER_GAMEOBJCLASS(GAMEOBJ, NAME, TYPE)const int GAMEOBJ::GetGObjID() {\
                                    ...
                                    const bool GAMEOBJ::IsRegister = CGameClassContainer::GetInst()->RegisterGameClass<GAMEOBJ>(GAMEOBJ::GObjID, NAME, &GAMEOBJ::InstanceGObj) ? []() -> bool {LOG_DEBUG(GAMEOBJ::GObjID, " - ", NAME); return true;}() : false;
...
public:
    ...
    std::weak_ptr<class CChapter> GetChater() { return mChapter; }
